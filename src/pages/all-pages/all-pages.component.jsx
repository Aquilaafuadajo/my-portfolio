  ...
  return ( 
      <div className='contact'>
        <div className='upper'>
          ...
          <a target='_blank noopener noreferrer' href='https://docs.google.com/document/d/1K-3tLFzcJ5J5PSe22_vz6YrQdirJcP5h_9bPMtZ9UCg/edit?usp=sharing'><button>my resume</button></a>
        </div>
  ...
  return ( 
      <div className='contact'>
        <div className='skill-description'>
          ...
          <p>View my <a target='_blank noopener noreferrer' style={{textDecoration: 'underline'}} href='https://docs.google.com/document/d/1K-3tLFzcJ5J5PSe22_vz6YrQdirJcP5h_9bPMtZ9UCg/edit?usp=sharing'>resume</a> for more details on my experience</p>
        </div>
      </div>
    );
}
